            ...
            <div className="portfolio-page-container">
                ...
                <div className="portfolio-page-content fade-in-2">
                    ...
                    <div className="site-card-container">
                        <SiteCard image="https://api.deandivizio.com/wp-content/uploads/2024/03/DeanDiviziocom-Screencap.jpg" title="This Site!" text={`Built on React, this site is an example of a simple but elegant design, developed with a modern tech stack. You can <a href=${repoLink}>view the code here</a>.`} />
                    </div>
                </div>
                <Footer big />
            </div>
