...
<p>It's one thing to make great content. It's another to know how to implement it properly. However, the real goal is to use these skills to help others and further business goals effectively. I've been fortunate enough to do all three.</p>
